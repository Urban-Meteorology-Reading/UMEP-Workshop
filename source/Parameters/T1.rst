...
- if you have observations for a long period (e.g. changing phenology) then you can calculate your own values. The following paper explian how:
 
  - Omdivar et al. (2020) - there are Jupyter Notebooks with code for may model parameters *start here*
  - Ward et al. (2016)
  - Jarvi et al. (2011)
