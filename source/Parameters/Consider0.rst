...
<https://suews.readthedocs.io/en/latest/prepare-to-run-the-model.html#preparation-of-data>`_.  `Later on you <CalParm>` you are introduced into how to calculate some parameters from observations.
